			...
			.ready(
					...
					$('#selectCountry').selectpicker({
						...
						{	
							...
							pieChartTooltipTitle = " energy requirements in "+ propertyName+" equivalent [MT] ";
							}
						}
						else
						{
							...
							if(propertyValue=="1"){
								...
								pieChartTooltipTitle= " protein requirements in "+ propertyName+" equivalent [MT] ";							
							}
						...
						if (yearNo == animalData[increment].year) {
							if (unitIndx == "Energy") {
								...
								if (energyIndex != null
									...
									nutrition = nutrition
											+ formatNumberRoundOff((animalData[increment].animalCount
													* animalData[increment].nonForageRate * energyIndex * 35600)/(parseFloat(propertyValue)*1000000));
								...
								if (proteinIndex != null
									...
									nutrition = nutrition
											+ formatNumberRoundOff((animalData[increment].animalCount
													* animalData[increment].nonForageRate * proteinIndex *0.319)/(parseFloat(propertyValue)*1000));
								}
			...
			/*	if(unitIndx == "Energy")
				...
				if (yearIndex == arrYears.length ) {
					...
					if(latestYear==yearNo){
					 ...
					 $("#para").text('Share of different animal types/species of total estimated feed demand for Year:'+latestYear+' ' );
					 $("#para1").text(subtitle );
		...
		<div id="visualizeDiv">
				<div  class="row">			
						...
						<div class="col-md-3" id="formTabOne" align="top" data-toggle="popover" width="100px" data-placement="left" title="Compare the composition of estimated feed demand in two of the countries you had previously selected. If you want to change a focus country, first deselect that country before activating a new one." >
							<div class="form-group" id="countryIdList" style="margin-top:20px; font-size:16px;">
								<label for="selectPieCountry" style="text-align:left">Select country/ies(up to two) <sub><font color="orange">[?]</font></sub></label> 
							</div>
						</div>
						<div class="col-md-3" id="formTabOne" align="top" data-toggle="popover" width="100px" data-placement="right" title="The composition of estimated feed demand varies over time, so please select a year; by default, the latest year is activated. The composition of feed demand in two countries can only be compared for the same year.">
							<div class="form-group" id="eeFormGroup"  style="margin-top:20px; font-size:16px;" >
								<label for="selectYear"  >Select year  <sub><font color="orange">[?]</font></sub> </label> 
							</div>
						</div>	
						<div class="col-md-3"></div>
				</div>
...
<div  style="padding-top: 40px" >
	<P id="para" ALIGN="CENTER" style="font-size:16px;"></P>
	<P id="para1" ALIGN="CENTER" style="font-size:16px;"></P>
</div>
